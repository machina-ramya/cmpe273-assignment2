...
public class BookResource {
    ...
    private final LibraryServiceConfiguration configs;
    ...
    private void sendMessageToQueue (String aQueueName, String aMessageString) throws JMSException {

        String user = configs.getApolloUser(); 
        String password = configs.getApolloPassword(); 
        String host = configs.getApolloHost(); 
        int port = configs.getApolloPort();
        ...
        System.out.println("Sending messages to " + aQueueName + "...");
        TextMessage msg = session.createTextMessage(aMessageString);
