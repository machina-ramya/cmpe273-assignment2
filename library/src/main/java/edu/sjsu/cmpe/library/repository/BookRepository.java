...
public class BookRepository implements BookRepositoryInterface {
    ...
    public Book saveBook(Book newBook) {
    	...
    	// Generate new ISBN if not present in the 
     ...
     * This assumes that the book will contain the unique ISBN
     * Therefore it will not generate the ISBN.
     */
    @Override
    ...
    public void updateStatus(Long aIsbn, Book.Status aStatus) {
        Book book = bookInMemoryMap.get(aIsbn);
        if( book != null ) {
            book.setStatus(aStatus);
        }
    }
